...
do
  ...
  do
    sh scripts/train_trans_nlu_cll_er_kd.sh \
       ...
       "vanilla" \
       "multi_head_in" \
       "encoder.layer.0._encoder.layer.1._encoder.layer.2._encoder.layer.3._encoder.layer.4._encoder.layer.5._encoder.layer.6._encoder.layer.7._encoder.layer.8." \
       "0_1_2_3_4_5_6" \
       "none" \
       "yes" \
       $SEED \
