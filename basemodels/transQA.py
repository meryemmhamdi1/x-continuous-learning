...
class TransQA(nn.Module):
    ...
    def forward(self,
        ...
        if self.use_adapters:
            ...
            sequence_outputs = lm_output[0] # last_hidden_state => 0 , pooler_output => 1

        results = Results(pool_out=sequence_outputs, # TODO VERIFY THIS 
        ...
        if start_positions is not None and end_positions is not None:
            ...
            loss_fct = self.criterion(ignore_index=ignored_index)
