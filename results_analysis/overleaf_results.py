...
def table4(all_per_order_metrics):
    ...
    for method in ["vanilla",
        ...
        # line_w_stds += str(metric[2]) + " $\pm " + str(metric[3]) + "$ & " + \
...
if __name__ == "__main__":
    ...
    root_dir = "/Users/meryem/Desktop/x-continuous-learning-repro-backup/metrics/bootstrap/"
    ...
    #### AVG
    with open(root_dir+"all/all_avg_metrics_bootstrap.pickle", "rb") as file:
        all_avg_metrics = pickle.load(file)

    #### Per order
    with open(root_dir+"all/all_per_order_metrics_bootstrap.pickle", "rb") as file:
        all_per_order_metrics = pickle.load(file)

    #### Per lang Forgetting
    with open(root_dir+"all/all_forget_lang_strings_bootstrap.pickle", "rb") as file:
        all_forget_lang_metrics = pickle.load(file)

    #### Per lang FWT
    with open(root_dir+"all/all_fwt_lang_strings_bootstrap.pickle", "rb") as file:
        all_fwt_lang_metrics = pickle.load(file)

    #### Per lang FWT mono
    with open(root_dir+"all/all_fwt_mono_lang_strings_bootstrap.pickle", "rb") as file:
